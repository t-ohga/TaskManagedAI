...
ToolAllowedAction = Literal["web_fetch", "docs_search", "code_grep", "filesystem_read"]
...
ALL_TOOL_ALLOWED_ACTIONS: Final[frozenset[str]] = frozenset(
    {"web_fetch", "docs_search", "code_grep", "filesystem_read"}
)
P0_DENY_TOOL_ACTIONS: Final[frozenset[str]] = frozenset(
    {"tool_write", "repo_write", "command_exec"}
)
...
_LITERAL_CHECKS: Final[tuple[tuple[str, frozenset[str], frozenset[str]], ...]] = (
    ...
    (
        "ToolAllowedAction",
        frozenset(get_args(ToolAllowedAction)),
