...
def evaluate_policy_block_recall(
    ...
    *,
    ...
    for fixture in corpus.fixtures:
        ...
        # (at-most-one-non-None invariant、backup_restore.py pattern と整合).
    ...
    # F-PR64-034 P2 adopt: spec violation 時 metric=0.0 (mixed corpus で 0.5 等の
    # fractional score を P0 dashboard に publish させない、backup_restore.py pattern).
    if fixture_count == 0:
        metric_value = 0.0
