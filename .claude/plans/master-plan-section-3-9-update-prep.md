...
+| `SP-012_p0_acceptance.md` (heavy) | **completed** (Phase 7a Mac single-host drill PASS 後、F-R3-001 R3 fix で T09 → Phase 7a に訂正) | PR #59-#67 (skeleton) + PR #76-#88 (must_ship batch 1-D) | skeleton + must_ship 完遂、SP-022 で T08 carry-over 完了 |
...
+| `SP-022_framework_intake_hardening.md` (heavy) | **completed** (Phase 7a Mac single-host drill PASS 後、Phase 7b T09 Mac→VPS は post-acceptance、F-R3-001 R3 fix 反映) | T00 PR #69 / T01-T07 PR #70-#80 / T08 batch PR #76,#77,#78,#79,#90,#91 / T06 KPI PR #89 / Review #92 / Additional Hardening Gate PR #95+#96+#97 + Phase 7 split PR #99 (p0-exit-final-hardening-2026-05-22 plan + 訂正) | pre-P0.1 unblock sprint 完遂、Phase 7a Mac single-host 運用立証 PASS + ADR-00021/00007 accepted (SP022-T00 で済) + Additional Hardening Gate 12 latent issues fix。Phase 7b T09 Mac→VPS は post-acceptance verification として任意 timing |
