...
### Phase 7: T09 drill (user 必須)

本 plan 完了 + Layer B/C smoke (autonomous 可能箇所) PASS 後、user が T09 host migration drill (Mac→VPS、RTO≤4h) 実施:
...
drill 完了後、user から checklist results を渡され、Claude が次 Phase 着手。
...
- [ ] SP-022 T09 host migration drill PASS + checklist 7 件 PASS (user 待ち)
...
| Phase 7 (T09 drill) | (none) | **explicit user approval** (user 物理作業必須) | user 完遂報告 |
| Phase 8 (P0 Exit declaration PR) | PR 起票 / master plan update / release docs | **notify-only** | (起票のみ) |
