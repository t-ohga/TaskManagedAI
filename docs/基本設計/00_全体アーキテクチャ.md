...
| Tool Registry | tool_registry、tool_network_policies、tool_versions、tool_permissions、trust_tier | P0 は `local|stdio`、`web_fetch|docs_search` deny-only、`network_access='none'` |
