...
| BL-0097 | GitHubAppAdapter httpx wrapper (broker-mediated only) | 8 → 11 | SP-008 | retries / rate limit / api_version=2022-11-28 / no raw token leak | `tests/repoproxy/test_github_app_adapter.py` 新規 |
