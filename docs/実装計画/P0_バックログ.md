...
| SP0095-UI-03 | Decision packet hash visibility | 9 → 9.5 | SP-009-5_p0_ui_deferred_surfaces | artifact_hash / diff_hash / policy_version / provider_request_fingerprint / stale_after_event_seq を表示 | 不足 field は API contract PR に分離 |
