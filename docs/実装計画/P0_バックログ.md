...
| SP0095-API-01 | Notification triage minimal lifecycle | 9 → 9.5 → partial | SP-009-5_p0_ui_deferred_surfaces | 2026-05-24 Batch D1 で required_action / severity / due_at / snooze / dedupe / resolved fields、redacted triage endpoint、actor-owned snooze/resolve、frontend API schema、migration up/down 検証を追加済。残作業は D2 `/notifications` UI actions | ADR-00003 event schema gate |
