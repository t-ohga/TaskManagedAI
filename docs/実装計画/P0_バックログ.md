...
| SP0095-UI-02 | Unified execution timeline read-only UI | 9 → 9.5 | SP-009-5_p0_ui_deferred_surfaces | AgentRunEvent / AuditEvent / Approval / Budget / Eval summary を redacted timeline として統合 | raw payload DOM exposure 禁止 |
