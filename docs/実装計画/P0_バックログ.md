...
| BL-0100 | AgentRunEvent `repo_pr_opened` actual emission | 8 → 11 | SP-008 | MockRepoProxy → AgentRuntime 経路結線 + payload schema | `tests/agent_runtime/test_repo_pr_opened_event.py` 新規 |
