...
|---|---|---|---|---|---|
| SP0095-UI-01 | Today/Inbox control plane + minimal KPI strip read-only UI | 9 → 9.5 | SP-009-5_p0_ui_deferred_surfaces | existing API だけで daily open/due/unassigned work と P0 KPI source を表示 | no mutation |
