...
| SP0095-API-01 | Notification triage minimal lifecycle | 9 → 9.5 | SP-009-5_p0_ui_deferred_surfaces | required_action / severity / due_at / snooze / dedupe / resolved fields の採否と migration | ADR-00003 event schema gate |
