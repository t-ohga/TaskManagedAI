...
| SP0095-API-01 | Notification triage minimal lifecycle | 9 → 9.5 → planned | SP-009-5_p0_ui_deferred_surfaces | 2026-05-24 Batch D plan で required_action / severity / due_at / snooze / dedupe / resolved fields、redacted triage endpoint、D1 DB/API + D2 UI split を固定済。runtime 実装は次 PR | ADR-00003 event schema gate |
