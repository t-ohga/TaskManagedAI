...
|---|---|---|---|---|
| BL-0096a | RepoProxy 4 整合 binding server-side 再計算 refactor | 8 → 11 | `create_draft_pr(approval_id, agent_run_id)` signature + DB / ContextSnapshot / Git ref から 4 hash 再計算 | `tests/repoproxy/test_4integrity_negative.py` 新規 (1 mismatch per case) |
