...
| SP0095-API-02 | Approval `request_revision` loop | 9 → 9.5 | SP-009-5_p0_ui_deferred_surfaces | revision_requested state / stale invalidation / revalidation / human-only decider | ADR-00003 / ADR-00004 / ADR-00009 gate |
