...
| BL-0102 | AC-KPI-02 `time_to_merge` 計測 endpoint (`/agent-runs/{id}/kpi`) | 8 → 11 | SP-008 | Draft PR created_at → merged_at median 計算 | `tests/contracts/test_kpi_time_to_merge.py` |
