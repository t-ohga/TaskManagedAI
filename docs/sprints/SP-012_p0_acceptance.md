...
- 5+ source 整合 (.claude/rules/cross-source-enum-integrity.md §1): frozenset / PRD-01 / hard-gates-and-kpis.md §2 / .claude/CLAUDE.md §重要原則 / pytest EXPECTED / eval/security/<dataset>/manifest.json の **完全一致 (set equality)** ✅
