...
- **SP-008 `partial_skeleton` 維持** (Codex F-PR39-002 adopt): 2026-05-24 follow-up で BL-0096a / BL-0101a / BL-0100 / BL-0102 は service-boundary / endpoint level まで前進。real GitHub transport、live Git ref re-fetch、webhook concrete adapters/routes、external API/worker adoption が残るため `done` 昇格は時期尚早
