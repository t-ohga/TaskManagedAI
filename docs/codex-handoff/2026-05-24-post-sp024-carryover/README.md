...
3. For SP-009-5, Batch E must use `plans/task-12-sp0095-request-revision-contract-plan.md`; E1 DB/API is implemented, and E2 UI + E3 revised-artifact handoff remain.
