...
4. For SP-009-5 Batch F, use `plans/task-16-sp0095-newcomer-path-contract-plan.md`; F1 read-only `/onboarding` is implemented, and F2+ API/schema/runtime work remains separately gated.
