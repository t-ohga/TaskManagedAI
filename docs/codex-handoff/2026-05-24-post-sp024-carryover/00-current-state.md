...
- SP-009-5 continuation: implement Newcomer Path F2 guided intake dry-run contract as P0.1 polish, using the F0 contract plan before any API/schema/runtime work.
